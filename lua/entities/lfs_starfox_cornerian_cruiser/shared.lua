...
ENT.PrintName = "Cornerian Cruiser Mk. II"
...
ENT.MDL = "models/cpthazama/starfox/vehicles/cornerian_carrier.mdl"
...
ENT.RotorPos = Vector(7500,0,300)
ENT.WingPos = Vector(-2500,0,250)
ENT.ElevatorPos = Vector(-4500,0,420)
ENT.RudderPos = Vector(-4500,0,420)
