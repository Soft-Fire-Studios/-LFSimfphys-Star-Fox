...
function ENT:Draw()
	...
	local Size = 500 + (self:GetRPM() / self:GetLimitRPM()) * 300 + Boost

	for i = 1,2 do
		render.SetMaterial(mat)
		render.DrawSprite(self:GetAttachment(3 +i).Pos,Size,Size,Color(50,200,50,255))
	end
end
...
function ENT:EngineActiveChanged( bActive )
	if bActive then
		self.ENG = CreateSound( self, "LFS_SF64_WOLFEN_ENGINE" )
		self.ENG:PlayEx(0,0)
		-- self.ENG2 = CreateSound( self, "LFS_SF64_WOLFEN_ENGINE" )
