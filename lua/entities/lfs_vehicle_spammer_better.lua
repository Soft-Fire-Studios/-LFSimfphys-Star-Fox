...
ENT.PrintName = "AI Better Vehicle Spammer"
ENT.Author = "Luna"
...
function ENT:SetupDataTables()
	...
	self:NetworkVar( "Int",3, "TeamOverride", { KeyName = "AI Team", Edit = { type = "Int", order = 4,min = -1, max = 100, category = "Vehicle-Options"} } )
