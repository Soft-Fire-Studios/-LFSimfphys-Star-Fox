...
ENT.MDL = "models/cpthazama/starfox/vehicles/wolfen_ii.mdl"
...
SF.AddShipData("lfs_starfox_wolfen_ii",ENT.PrintName,ENT.MDL,ENT.MaxHealth,ENT.MaxShield,ENT.MaxPrimaryAmmo,ENT.MaxSecondaryAmmo,nil,40)
