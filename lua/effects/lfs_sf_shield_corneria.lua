local Mat = "effects/starfox/shield_corneria"
local MatColor = Color(255,255,255)
local FXColor = Color(255,255,255)
-- local MatColor = Color(200,220,255,255)
-- local FXColor = Color(0,127,255,255)
...
function EFFECT:Spark( pos )
	...
	for i = 0, 20 do
		...
		if particle then
			...
			particle:SetColor( FXColor.r,FXColor.g,FXColor.b )
...
function EFFECT:Render()
	...
	render.DrawSprite( self.Pos, 800 * Scale, 800 * Scale, FXColor )
